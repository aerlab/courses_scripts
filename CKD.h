!
! gase absorption data
! 

! data block from band 1 to band 18      
     real ::     hk1(10), fk1o3(10)  ,            & 
               hk2(8), c2h2o(3,11,8),            & 
               hk3(12), c3h2o(3,11,12),           & 
               hk4(7), c4h2o(3,11,7)   ,        & 
     	       hk5(12), c5h2o(3,11,12)  ,         & 
       	       hk6(5), c6h2o(3,11,5)    ,       & 
      	       hk7(2), c7h2o(3,19,2)    ,       & 
      	       hk8(3), c8h2o(3,19,3)    ,       & 
      	       hk9(4), c9h2o(3,19,4)    ,       & 
      	       hk10(4),c10h2o(3,19,4),c10ch4(3,19),c10n2o(3,19),           & 
               hk11(3),c11h2o(3,19,3),c11ch4(3,19),c11n2o(3,19),           & 
               hk12(5), c12o3(3,19,5), c12h2o(3,19) ,          & 
               hk13(2), c13h2o(3,19,2)       ,    & 
               hk14(10), c14hca(3,19,10), c14hcb(3,19,10),           & 
               hk15(12), c15hca(3,19,12), c15hcb(3,19,12) ,          & 
               hk16(7), c16h2o(3,19,7) ,          & 
               hk17(7), c17h2o(3,19,7) ,          & 
               hk18(8), c18h2o(3,19,8)
      
      integer i, j, k
       
              
	data hk1 / .24, .16, .24, .28, .03, &
                 .016, .01, .008, .008, .008 /
	data fk1o3 / .2204e-08,.1207e-01,.4537e-01,.1032e+00,.1740e+00, &
        ...
        data ( ( ( c2h2o(k,j,i), i = 1, 8 ), j = 1, 11 ), k = 1, 3 ) /   &
      ...
      data hk3 / .34, .11, .1, .09, .12, .1,   &
                  .06, .04, .026, .01, .0035, .0005 /
      data ( ( ( c3h2o(k,j,i), i = 1, 12 ), j = 1, 11 ), k = 1, 3 ) /   &
...
!      common /band4/ hk(7), coeh2o(3,11,7)
      ...
      data ( ( ( c4h2o(k,j,i), i = 1, 7 ), j = 1, 11 ), k = 1, 3 ) /   &
...
!     common /band5/ hk(12), coeh2o(3,11,12)
      data hk5 / .13, .14, .13, .16, .18, .14,    &
                  .07, .02, .016, .008, .004, .002 /
      data ( ( ( c5h2o(k,j,i), i = 1, 12 ), j = 1, 11 ), k = 1, 3 ) /   &
      ...
      data hk6 / .3, .2, .2, .2, .1 /
      data ( ( ( c6h2o(k,j,i), i = 1, 5 ), j = 1, 11 ), k = 1, 3 ) /   &
      ...
      data ( ( ( c8h2o(k,j,i), i = 1, 3 ), j = 1, 19 ), k = 1, 3 ) /   &
      ...
      data ( ( ( c9h2o(k,j,i), i = 1, 4 ), j = 1, 19 ), k = 1, 3 ) /   &
      ...
      data ( ( ( c10h2o(k,j,i), i = 1, 4 ), j = 1, 19 ), k = 1, 3 ) /   &
      ...
      data ( ( ( c11h2o(k,j,i), i = 1, 3 ), j = 1, 19 ), k = 1, 3 ) /   &
      ...
      data ( ( ( c12o3(k,j,i), i = 1, 5 ), j = 1, 19 ), k = 1, 3 ) /   &
      ...
      -.9248E-04,-.1050E-03,-.1031E-03/
       ...
       data hk13 / 0.95, 0.05 /
      data ( ( ( c13h2o(k,j,i), i = 1, 2 ), j = 1, 19 ), k = 1, 3 ) /   &
      ...
      data ( ( ( c14hca(k,j,i), i = 1, 10 ), j = 1, 19 ), k = 1, 3 ) /   &
      ...
      data ( ( ( c14hcb(k,j,i), i = 1, 10 ), j = 1, 19 ), k = 1, 3 ) /   &
      ...
      data ( ( ( c15hca(k,j,i), i = 1, 12 ), j = 1, 19 ), k = 1, 2 ) /   &
      ...
      data ( ( ( c15hca(k,j,i), i = 1, 12 ), j = 1, 19 ), k = 3, 3 ) /   &
      ...
      data ( ( ( c15hcb(k,j,i), i = 1, 12 ), j = 1, 19 ), k = 1, 2 ) /   &
      ...
      data ( ( ( c15hcb(k,j,i), i = 1, 12 ), j = 1, 19 ), k = 3, 3 ) /   &
      ...
      data ( ( ( c16h2o(k,j,i), i = 1, 7 ), j = 1, 19 ), k = 1, 3 ) /   &
      ...
      data ( ( ( c17h2o(k,j,i), i = 1, 7 ), j = 1, 19 ), k = 1, 3 ) /   &
      ...
      data ( ( ( c18h2o(k,j,i), i = 1, 8 ), j = 1, 19 ), k = 1, 3 ) /   &
	...
	integer, parameter:: ncoef=7,nband=12
	real, dimension(ncoef, nband) ::  aa0,aa1,aa2,aa3,aa4
